...
class TestYouTubeTranscriber:
    ...
    def test_download_audio_success(self, mock_ydl, transcriber):
        ...
        mock_instance.extract_info.return_value = {"title": "Test Video", "id": "test123"}
    ...
    def test_process_video_success(self, mock_save, mock_transcribe, mock_download, transcriber):
